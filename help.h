...
static struct argp_option optionsViewadsb[] = {
    ...
    {"alt", OptAlt, "<alt>", 0, "Receiver altitude in meters (or feet with 'ft' suffix, e.g. 1000ft)", 1},
    ...
    {"ownship", OptOwnship, "<hex|callsign>", 0, "Set ownship by ICAO hex ID or callsign (highlighted in display, sent to readsb for EFB)", 1},
